...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer: The datatype of "id" is character, that of "seats"**
...
1.   Which department's number of courses is in the biggest decline?

2.  For those instructors who has taught for over 5 years, which instructors teach different courses every single year? And which one teach the same courses every year?

3.  Which department opened the highest number of courses without prerequisites and restrictions?
